                ...
                if (pseudo != "" && adresse != "" && tel != "") {
                    ...
                    if ((i >= 1) && (i <= 4)) {
                       ...
                       // if si != evasion braquage ...
                        ...
                        System.out.println("il n'y pas  ou trop de case(s) cochée(s)");
                        int messageretour = 3;
                        request.setAttribute("message", messageretour);
                        this.getServletContext().getRequestDispatcher("/WEB-INF/Pages/inscription.jsp").forward(request, response);
                    ...
                    System.out.println("Le pseudo ou le lieu d'habitation ou le numéros de téléphone n'est pas remplis");
                    int messageretour = 1;
                    request.setAttribute("message", messageretour);
                    this.getServletContext().getRequestDispatcher("/WEB-INF/Pages/inscription.jsp").forward(request, response);
